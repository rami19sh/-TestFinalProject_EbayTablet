...
class TestTest3():
  ...
  def test_test3(self):
    ...
    time.sleep(3)
    price_unit=float(self.driver.find_element(By.CSS_SELECTOR,"#mainContent > div > div.right-section > div > div.table > div:nth-child(1) > div.val-col > span > span > span").text)
    time.sleep(5)
    print(price_unit)
